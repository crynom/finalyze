...
# @timer
def main():
    michael = Portfolio('Michael')
    # print(michael.add_stock('tsla',170),f'worth ${michael.stocks[0].worth:.2f}')
    print(michael.add_stock('hut', 800))
    print(michael.add_stock('hut', 200, 100))
    print(michael.stocks[0].cb)
    # print(michael.variance)
    print(michael.add_stock('amd', 75))
    print(michael.stocks[1].shares)
    print(michael.remove_stock('amd', 100))
    print(michael.add_stock('amd', 100))
    print(michael.remove_stock('amd'))
    print(michael.add_stock('amd',85))
    print(michael.remove_stock('amd', 15))
    print()
    print(michael.stocks[1].shares)
    michael.save()
    michael.load('michael')
    print(michael.stocks[0].cb)

    # print(michael.variance)
    # michael.add_stock('aapl', 200)
    # print(michael.variance)
    # michael.add_stock('goog', 1)
    # print(michael.variance)
    # michael.add_stock('nvda', 10)
    # print(michael.variance)
    # print(michael.data)
    # michael.saveas('testing')
    # michael.load('testing')
    # michael.print_portfolio()
    # michael.print_opt()
    # michael.generate_portfolio(35)
    # michael.print_gains()
    # michael.plot_stocks()
    # michael.plot_portfolio_logdist()
    # michael.EF()
    # michael.plot_logdist()
    # michael.plot_logdist(1000)
    # print(michael.returns.head())
    # print(michael.stocks[0].log_returns.head(),michael.stocks[1].log_returns.head())
    # print(michael.expected, michael.expectation)
    # print(f'Total Value: ${michael.value:,.2f}')
    # michael.stocks[1].dist_log()
    # show()
    # print(michael.stocks[0],michael.stocks)
